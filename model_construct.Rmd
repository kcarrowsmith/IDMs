...
for(i in 1:100){
  ...
  ## Step 4b: Save evaluation scores
  ...
  bifcham.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(bifcham.idm)), na.omit(values(bifcham.overlap)), na.rm = T))
...
saveRDS(bifcham.overlaplist, file = "bifcham-overlaps.RData")
saveRDS(bifcham.idmlist, file = "bifcham-idms.RData")

# Some extra code to figure out threshold stuff. Will integrate into the main for loop later.
...
for(i in 1:100){
  overlap = bifcham.overlaplist[[i]]
  tstar.overlap = (bifcham.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(overlap, lower = tstar.overlap, upper = 1, values = T)
  ...
  idm = bifcham.idmlist[[i]]
  tstar.idm = (bifcham.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(idm, lower = tstar.idm, upper = 1, values = T)
...
for(i in 1:100){
  ...
  bifcir.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(bifcir.idm)), na.omit(values(bifcir.overlap)), na.rm = T))
...
saveRDS(bifcir.overlaplist, file = "bifcir-overlaps.RData")
saveRDS(bifcir.idmlist, file = "bifcir-idms.RData")
...
for(i in 1:100){
  ...
  biflup.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(biflup.idm)), na.omit(values(biflup.overlap)), na.rm = T))
...
saveRDS(biflup.overlaplist, file = "biflup-overlaps.RData")
saveRDS(biflup.idmlist, file = "biflup-idms.RData")
...
for(i in 1:100){
  ...
  bifpen.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(bifpen.idm)), na.omit(values(bifpen.overlap)), na.rm = T))
...
```{r bifrub maxent for loop, message = F}
...
for(i in 1:100){
  ...
  bifrub.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(bifrub.idm)), na.omit(values(bifrub.overlap)), na.rm = T))
...
saveRDS(bifrub.overlaplist, file = "bifrub-overlaps.RData")
saveRDS(bifrub.idmlist, file = "bifrub-idms.RData")
...
for(i in 1:100){
  ...
  flavcham.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(flavcham.idm)), na.omit(values(flavcham.overlap)), na.rm = T))
...
saveRDS(flavcham.overlaplist, file = "flavcham-overlaps.RData")
saveRDS(flavcham.idmlist, file = "flavcham-idms.RData")
...
for(i in 1:100){
  overlap = flavcham.overlaplist[[i]]
...
for(i in 1:100){
  ...
  flavcir.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(flavcir.idm)), na.omit(values(flavcir.overlap)), na.rm = T))
...
saveRDS(flavcir.overlaplist, file = "flavcir-overlaps.RData")
saveRDS(flavcir.idmlist, file = "flavcir-idms.RData")
...
for(i in 1:100){
  ...
  flavlup.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(flavlup.idm)), na.omit(values(flavlup.overlap)), na.rm = T))
...
saveRDS(flavlup.overlaplist, file = "flavlup-overlaps.RData")
saveRDS(flavlup.idmlist, file = "flavlup-idms.RData")
...
for(i in 1:100){
  ...
  flavpen.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(flavpen.idm)), na.omit(values(flavpen.overlap)), na.rm = T))
...
saveRDS(flavpen.overlaplist, file = "flavpen-overlaps.RData")
saveRDS(flavpen.idmlist, file = "flavpen-idms.RData")
...
for(i in 1:100){
  ...
  flavrub.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(flavrub.idm)), na.omit(values(flavrub.overlap)), na.rm = T))
...
saveRDS(flavrub.overlaplist, file = "flavrub-overlaps.RData")
saveRDS(flavrub.idmlist, file = "flavrub-idms.RData")
...
for(i in 1:100){
  ...
  mixcham.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(mixcham.idm)), na.omit(values(mixcham.overlap)), na.rm = T))
...
saveRDS(mixcham.overlaplist, file = "mixcham-overlaps.RData")
saveRDS(mixcham.idmlist, file = "mixcham-idms.RData")
...
for(i in 1:100){
  ...
  mixcir.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(mixcir.idm)), na.omit(values(mixcir.overlap)), na.rm = T))
...
saveRDS(mixcir.overlaplist, file = "mixcir-overlaps.RData")
saveRDS(mixcir.idmlist, file = "mixcir-idms.RData")
...
for(i in 1:100){
  ...
  mixlup.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(mixlup.idm)), na.omit(values(mixlup.overlap)), na.rm = T))
...
saveRDS(mixlup.overlaplist, file = "mixlup-overlaps.RData")
saveRDS(mixlup.idmlist, file = "mixlup-idms.RData")
...
for(i in 1:100){
  ...
  mixpen.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(mixpen.idm)), na.omit(values(mixpen.overlap)), na.rm = T))
...
saveRDS(mixpen.overlaplist, file = "mixpen-overlaps.RData")
saveRDS(mixpen.idmlist, file = "mixpen-idms.RData")
...
for(i in 1:100){
  ...
  mixrub.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(mixrub.idm)), na.omit(values(mixrub.overlap)), na.rm = T))
...
saveRDS(mixrub.overlaplist, file = "mixrub-overlaps.RData")
saveRDS(mixrub.idmlist, file = "mixrub-idms.RData")
...
for(i in 1:100){
  ...
  voscham.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(voscham.idm)), na.omit(values(voscham.overlap)), na.rm = T))
...
saveRDS(voscham.overlaplist, file = "voscham-overlaps.RData")
saveRDS(voscham.idmlist, file = "voscham-idms.RData")
...
for(i in 1:100){
  ...
  voscir.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(voscir.idm)), na.omit(values(voscir.overlap)), na.rm = T))
...
saveRDS(voscir.overlaplist, file = "voscir-overlaps.RData")
saveRDS(voscir.idmlist, file = "voscir-idms.RData")
...
for(i in 1:100){
  ...
  voslup.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(voslup.idm)), na.omit(values(voslup.overlap)), na.rm = T))
...
saveRDS(voslup.overlaplist, file = "voslup-overlaps.RData")
saveRDS(voslup.idmlist, file = "voslup-idms.RData")
...
for(i in 1:100){
  ...
  vospen.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(vospen.idm)), na.omit(values(vospen.overlap)), na.rm = T))
...
saveRDS(vospen.overlaplist, file = "vospen-overlaps.RData")
saveRDS(vospen.idmlist, file = "vospen-idms.RData")
...
for(i in 1:100){
  ...
  vosrub.overlap.eval = data.frame(run = i,
                        ...
                        RMSE = predicts::RMSE(na.omit(values(vosrub.idm)), na.omit(values(vosrub.overlap)), na.rm = T))
...
saveRDS(vosrub.overlaplist, file = "vosrub-overlaps.RData")
saveRDS(vosrub.idmlist, file = "vosrub-idms.RData")
