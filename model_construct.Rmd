...
for(i in 1:100){
  ...
  ## Step 4c: Normalize rasters for RMSE calculation
  ...
  tstar.overlap = (bifcham.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(bifcham.overlap, lower = tstar.overlap, upper = 1, values = T)
  ...
  tstar.idm = (bifcham.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(bifcham.idm, lower = tstar.idm, upper = 1, values = T)
...
for(i in 1:100){
  ...
  tstar.overlap = (bifcir.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(bifcir.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (bifcir.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(bifcir.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (biflup.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(biflup.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (biflup.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(biflup.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (bifpen.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(bifpen.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (bifpen.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(bifpen.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (bifrub.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(bifrub.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (bifrub.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(bifrub.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (flavcham.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(flavcham.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (flavcham.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(flavcham.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (flavcir.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(flavcir.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (flavcir.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(flavcir.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (flavlup.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(flavlup.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (flavlup.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(flavlup.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (flavpen.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(flavpen.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (flavpen.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(flavpen.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (flavrub.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(flavrub.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (flavrub.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(flavrub.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (mixcham.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(mixcham.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (mixcham.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(mixcham.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (mixcir.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(mixcir.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (mixcir.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(mixcir.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (mixlup.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(mixlup.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (mixlup.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(mixlup.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (mixpen.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(mixpen.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (mixpen.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(mixpen.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (mixrub.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(mixrub.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (mixrub.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(mixrub.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (voscham.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(voscham.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (voscham.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(voscham.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (voscir.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(voscir.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (voscir.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(voscir.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (voslup.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(voslup.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (voslup.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(voslup.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (vospen.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(vospen.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (vospen.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(vospen.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
...
for(i in 1:100){
  ...
  tstar.overlap = (vosrub.evaldf %>%
    filter(run == i,
           model == "overlap"))$tstar
  overlap.thresh = clamp(vosrub.overlap, lower = tstar.overlap, upper = 1, values = T)
  overlap.thresh[overlap.thresh > tstar.overlap] = 1
  overlap.thresh[overlap.thresh <= tstar.overlap] = 0
  ...
  tstar.idm = (vosrub.evaldf %>%
    filter(run == i,
           model == "IDM"))$tstar
  idm.thresh = clamp(vosrub.idm, lower = tstar.idm, upper = 1, values = T)
  idm.thresh[idm.thresh > tstar.idm] = 1
  idm.thresh[idm.thresh <= tstar.idm] = 0
