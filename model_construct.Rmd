...
bifcham.overlapnormlist <- vector(mode = "list", length = 100)
bifcham.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  bifcham.idmnormlist[[i]] = bifcham.idmnorm
  bifcham.overlapnormlist[[i]] = bifcham.overlapnorm
...
# Normalized
bifcham.overlapnorm.ensemble <- raster(mean(rast(bifcham.overlapnormlist[c(1:100)])))
bifcham.overlapnorm.spdf <- as(bifcham.overlapnorm.ensemble, "SpatialPixelsDataFrame")
bifcham.overlapnorm.df <- as.data.frame(bifcham.overlapnorm.spdf)

bifcham.overlapnorm.plot <- ggplot() +
  geom_tile(data = bifcham.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/bifcham-overlapnorm.png", bifcham.overlapnorm.plot, width = 6, height = 4, units = "in")

bifcham.idmnorm.ensemble <- raster(mean(rast(bifcham.idmnormlist[c(1:100)])))
bifcham.idmnorm.spdf <- as(bifcham.idmnorm.ensemble, "SpatialPixelsDataFrame")
bifcham.idmnorm.df <- as.data.frame(bifcham.idmnorm.spdf)

bifcham.idmnorm.plot <- ggplot() +
  geom_tile(data = bifcham.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/bifcham-idmnorm.png", bifcham.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
bifcham.overlap.tstar <- mean((bifcham.evaldf %>% filter(model == "overlap"))$tstar)
bifcham.overlap.threshensemble <- clamp(bifcham.overlapnorm.ensemble, lower = bifcham.overlap.tstar, upper = 1, values = T)
bifcham.overlap.threshensemble[bifcham.overlap.threshensemble > bifcham.overlap.tstar] = 1
bifcham.overlap.threshensemble[bifcham.overlap.threshensemble <= bifcham.overlap.tstar] = 0

bifcham.idm.tstar <- mean((bifcham.evaldf %>% filter(model == "IDM"))$tstar)
bifcham.idm.threshensemble <- clamp(bifcham.idmnorm.ensemble, lower = bifcham.idm.tstar, upper = 1, values = T)
bifcham.idm.threshensemble[bifcham.idm.threshensemble > bifcham.idm.tstar] = 10
bifcham.idm.threshensemble[bifcham.idm.threshensemble <= bifcham.idm.tstar] = 0

bifcham.threshold <- bifcham.overlap.threshensemble + bifcham.idm.threshensemble
bifcham.thresh.spdf <- as(bifcham.threshold, "SpatialPixelsDataFrame")
bifcham.thresh.df <- as.data.frame(bifcham.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

bifcham.thresh.plot <- ggplot() +
  geom_tile(data = bifcham.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
...
ggsave("figures/normalized/bifcham-threshold.png", bifcham.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(bifcham.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(bifcham.overlapthresh[[i]], "SpatRaster")

shared.thresh <- idm.thresh + overlap.thresh

idm.area <- shared.thresh
overlap.area <- shared.thresh

idm.area[idm.area != 10] = NA
overlap.area[overlap.area != 1] = NA

area.allruns <- bind_rows(area.allruns,
                     data.frame(run = i,
                                int = "bifcham",
                                idm = expanse(idm.area, unit = "km")$area,
                                overlap = expanse(overlap.area, unit = "km")$area))
}
```
...
bifcir.overlapnormlist <- vector(mode = "list", length = 100)
bifcir.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  bifcir.idmnormlist[[i]] = bifcir.idmnorm
  bifcir.overlapnormlist[[i]] = bifcir.overlapnorm
...
# Normalized
bifcir.overlapnorm.ensemble <- raster(mean(rast(bifcir.overlapnormlist[c(1:100)])))
bifcir.overlapnorm.spdf <- as(bifcir.overlapnorm.ensemble, "SpatialPixelsDataFrame")
bifcir.overlapnorm.df <- as.data.frame(bifcir.overlapnorm.spdf)

bifcir.overlapnorm.plot <- ggplot() +
  geom_tile(data = bifcir.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/bifcir-overlapnorm.png", bifcir.overlapnorm.plot, width = 6, height = 4, units = "in")

bifcir.idmnorm.ensemble <- raster(mean(rast(bifcir.idmnormlist[c(1:100)])))
bifcir.idmnorm.spdf <- as(bifcir.idmnorm.ensemble, "SpatialPixelsDataFrame")
bifcir.idmnorm.df <- as.data.frame(bifcir.idmnorm.spdf)

bifcir.idmnorm.plot <- ggplot() +
  geom_tile(data = bifcir.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/bifcir-idmnorm.png", bifcir.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
bifcir.overlap.tstar <- mean((bifcir.evaldf %>% filter(model == "overlap"))$tstar)
bifcir.overlap.threshensemble <- clamp(bifcir.overlapnorm.ensemble, lower = bifcir.overlap.tstar, upper = 1, values = T)
bifcir.overlap.threshensemble[bifcir.overlap.threshensemble > bifcir.overlap.tstar] = 1
bifcir.overlap.threshensemble[bifcir.overlap.threshensemble <= bifcir.overlap.tstar] = 0

bifcir.idm.tstar <- mean((bifcir.evaldf %>% filter(model == "IDM"))$tstar)
bifcir.idm.threshensemble <- clamp(bifcir.idmnorm.ensemble, lower = bifcir.idm.tstar, upper = 1, values = T)
bifcir.idm.threshensemble[bifcir.idm.threshensemble > bifcir.idm.tstar] = 10
bifcir.idm.threshensemble[bifcir.idm.threshensemble <= bifcir.idm.tstar] = 0

bifcir.threshold <- bifcir.overlap.threshensemble + bifcir.idm.threshensemble
bifcir.thresh.spdf <- as(bifcir.threshold, "SpatialPixelsDataFrame")
bifcir.thresh.df <- as.data.frame(bifcir.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

bifcir.thresh.plot <- ggplot() +
  geom_tile(data = bifcir.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/bifcir-threshold.png", bifcir.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(bifcir.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(bifcir.overlapthresh[[i]], "SpatRaster")
...
biflup.overlapnormlist <- vector(mode = "list", length = 100)
biflup.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  biflup.idmnormlist[[i]] = biflup.idmnorm
  biflup.overlapnormlist[[i]] = biflup.overlapnorm
...
# Normalized
biflup.overlapnorm.ensemble <- raster(mean(rast(biflup.overlapnormlist[c(1:100)])))
biflup.overlapnorm.spdf <- as(biflup.overlapnorm.ensemble, "SpatialPixelsDataFrame")
biflup.overlapnorm.df <- as.data.frame(biflup.overlapnorm.spdf)

biflup.overlapnorm.plot <- ggplot() +
  geom_tile(data = biflup.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/biflup-overlapnorm.png", biflup.overlapnorm.plot, width = 6, height = 4, units = "in")

biflup.idmnorm.ensemble <- raster(mean(rast(biflup.idmnormlist[c(1:100)])))
biflup.idmnorm.spdf <- as(biflup.idmnorm.ensemble, "SpatialPixelsDataFrame")
biflup.idmnorm.df <- as.data.frame(biflup.idmnorm.spdf)

biflup.idmnorm.plot <- ggplot() +
  geom_tile(data = biflup.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/biflup-idmnorm.png", biflup.idmnorm.plot, width = 6, height = 4, units = "in")


# Threshold
biflup.overlap.tstar <- mean((biflup.evaldf %>% filter(model == "overlap"))$tstar)
biflup.overlap.threshensemble <- clamp(biflup.overlapnorm.ensemble, lower = biflup.overlap.tstar, upper = 1, values = T)
biflup.overlap.threshensemble[biflup.overlap.threshensemble > biflup.overlap.tstar] = 1
biflup.overlap.threshensemble[biflup.overlap.threshensemble <= biflup.overlap.tstar] = 0

biflup.idm.tstar <- mean((biflup.evaldf %>% filter(model == "IDM"))$tstar)
biflup.idm.threshensemble <- clamp(biflup.idmnorm.ensemble, lower = biflup.idm.tstar, upper = 1, values = T)
biflup.idm.threshensemble[biflup.idm.threshensemble > biflup.idm.tstar] = 10
biflup.idm.threshensemble[biflup.idm.threshensemble <= biflup.idm.tstar] = 0

biflup.threshold <- biflup.overlap.threshensemble + biflup.idm.threshensemble
biflup.thresh.spdf <- as(biflup.threshold, "SpatialPixelsDataFrame")
biflup.thresh.df <- as.data.frame(biflup.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

biflup.thresh.plot <- ggplot() +
  geom_tile(data = biflup.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/biflup-threshold.png", biflup.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(biflup.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(biflup.overlapthresh[[i]], "SpatRaster")
...
bifpen.overlapnormlist <- vector(mode = "list", length = 100)
bifpen.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  bifpen.idmnormlist[[i]] = bifpen.idmnorm
  bifpen.overlapnormlist[[i]] = bifpen.overlapnorm
...
save(bifpen.overlaplist, file = "bifpen-overlaps.RData")
save(bifpen.idmlist, file = "bifpen-idms.RData")
```
...
# Normalized
bifpen.overlapnorm.ensemble <- raster(mean(rast(bifpen.overlapnormlist[c(1:100)])))
bifpen.overlapnorm.spdf <- as(bifpen.overlapnorm.ensemble, "SpatialPixelsDataFrame")
bifpen.overlapnorm.df <- as.data.frame(bifpen.overlapnorm.spdf)

bifpen.overlapnorm.plot <- ggplot() +
  geom_tile(data = bifpen.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/bifpen-overlapnorm.png", bifpen.overlapnorm.plot, width = 6, height = 4, units = "in")

bifpen.idmnorm.ensemble <- raster(mean(rast(bifpen.idmnormlist[c(1:100)])))
bifpen.idmnorm.spdf <- as(bifpen.idmnorm.ensemble, "SpatialPixelsDataFrame")
bifpen.idmnorm.df <- as.data.frame(bifpen.idmnorm.spdf)

bifpen.idmnorm.plot <- ggplot() +
  geom_tile(data = bifpen.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/bifpen-idmnorm.png", bifpen.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
bifpen.overlap.tstar <- mean((bifpen.evaldf %>% filter(model == "overlap"))$tstar)
bifpen.overlap.threshensemble <- clamp(bifpen.overlapnorm.ensemble, lower = bifpen.overlap.tstar, upper = 1, values = T)
bifpen.overlap.threshensemble[bifpen.overlap.threshensemble > bifpen.overlap.tstar] = 1
bifpen.overlap.threshensemble[bifpen.overlap.threshensemble <= bifpen.overlap.tstar] = 0

bifpen.idm.tstar <- mean((bifpen.evaldf %>% filter(model == "IDM"))$tstar)
bifpen.idm.threshensemble <- clamp(bifpen.idmnorm.ensemble, lower = bifpen.idm.tstar, upper = 1, values = T)
bifpen.idm.threshensemble[bifpen.idm.threshensemble > bifpen.idm.tstar] = 10
bifpen.idm.threshensemble[bifpen.idm.threshensemble <= bifpen.idm.tstar] = 0

bifpen.threshold <- bifpen.overlap.threshensemble + bifpen.idm.threshensemble
bifpen.thresh.spdf <- as(bifpen.threshold, "SpatialPixelsDataFrame")
bifpen.thresh.df <- as.data.frame(bifpen.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

bifpen.thresh.plot <- ggplot() +
  geom_tile(data = bifpen.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/bifpen-threshold.png", bifpen.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(bifpen.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(bifpen.overlapthresh[[i]], "SpatRaster")
...
bifrub.overlapnormlist <- vector(mode = "list", length = 100)
bifrub.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  bifrub.idmnormlist[[i]] = bifrub.idmnorm
  bifrub.overlapnormlist[[i]] = bifrub.overlapnorm
...
# Normalized
bifrub.overlapnorm.ensemble <- raster(mean(rast(bifrub.overlapnormlist[c(1:100)])))
bifrub.overlapnorm.spdf <- as(bifrub.overlapnorm.ensemble, "SpatialPixelsDataFrame")
bifrub.overlapnorm.df <- as.data.frame(bifrub.overlapnorm.spdf)

bifrub.overlapnorm.plot <- ggplot() +
  geom_tile(data = bifrub.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/bifrub-overlapnorm.png", bifrub.overlapnorm.plot, width = 6, height = 4, units = "in")

bifrub.idmnorm.ensemble <- raster(mean(rast(bifrub.idmnormlist[c(1:100)])))
bifrub.idmnorm.spdf <- as(bifrub.idmnorm.ensemble, "SpatialPixelsDataFrame")
bifrub.idmnorm.df <- as.data.frame(bifrub.idmnorm.spdf)

bifrub.idmnorm.plot <- ggplot() +
  geom_tile(data = bifrub.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/bifrub-idmnorm.png", bifrub.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
bifrub.overlap.tstar <- mean((bifrub.evaldf %>% filter(model == "overlap"))$tstar)
bifrub.overlap.threshensemble <- clamp(bifrub.overlapnorm.ensemble, lower = bifrub.overlap.tstar, upper = 1, values = T)
bifrub.overlap.threshensemble[bifrub.overlap.threshensemble > bifrub.overlap.tstar] = 1
bifrub.overlap.threshensemble[bifrub.overlap.threshensemble <= bifrub.overlap.tstar] = 0

bifrub.idm.tstar <- mean((bifrub.evaldf %>% filter(model == "IDM"))$tstar)
bifrub.idm.threshensemble <- clamp(bifrub.idmnorm.ensemble, lower = bifrub.idm.tstar, upper = 1, values = T)
bifrub.idm.threshensemble[bifrub.idm.threshensemble > bifrub.idm.tstar] = 10
bifrub.idm.threshensemble[bifrub.idm.threshensemble <= bifrub.idm.tstar] = 0

bifrub.threshold <- bifrub.overlap.threshensemble + bifrub.idm.threshensemble
bifrub.thresh.spdf <- as(bifrub.threshold, "SpatialPixelsDataFrame")
bifrub.thresh.df <- as.data.frame(bifrub.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

bifrub.thresh.plot <- ggplot() +
  geom_tile(data = bifrub.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/bifrub-threshold.png", bifrub.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(bifrub.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(bifrub.overlapthresh[[i]], "SpatRaster")
...
flavcham.overlapnormlist <- vector(mode = "list", length = 100)
flavcham.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  flavcham.idmnormlist[[i]] = flavcham.idmnorm
  flavcham.overlapnormlist[[i]] = flavcham.overlapnorm
...
# Normalized
flavcham.overlapnorm.ensemble <- raster(mean(rast(flavcham.overlapnormlist[c(1:100)])))
flavcham.overlapnorm.spdf <- as(flavcham.overlapnorm.ensemble, "SpatialPixelsDataFrame")
flavcham.overlapnorm.df <- as.data.frame(flavcham.overlapnorm.spdf)

flavcham.overlapnorm.plot <- ggplot() +
  geom_tile(data = flavcham.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavcham-overlapnorm.png", flavcham.overlapnorm.plot, width = 6, height = 4, units = "in")

flavcham.idmnorm.ensemble <- raster(mean(rast(flavcham.idmnormlist[c(1:100)])))
flavcham.idmnorm.spdf <- as(flavcham.idmnorm.ensemble, "SpatialPixelsDataFrame")
flavcham.idmnorm.df <- as.data.frame(flavcham.idmnorm.spdf)

flavcham.idmnorm.plot <- ggplot() +
  geom_tile(data = flavcham.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavcham-idmnorm.png", flavcham.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
flavcham.overlap.tstar <- mean((flavcham.evaldf %>% filter(model == "overlap"))$tstar)
flavcham.overlap.threshensemble <- clamp(flavcham.overlapnorm.ensemble, lower = flavcham.overlap.tstar, upper = 1, values = T)
flavcham.overlap.threshensemble[flavcham.overlap.threshensemble > flavcham.overlap.tstar] = 1
flavcham.overlap.threshensemble[flavcham.overlap.threshensemble <= flavcham.overlap.tstar] = 0

flavcham.idm.tstar <- mean((flavcham.evaldf %>% filter(model == "IDM"))$tstar)
flavcham.idm.threshensemble <- clamp(flavcham.idmnorm.ensemble, lower = flavcham.idm.tstar, upper = 1, values = T)
flavcham.idm.threshensemble[flavcham.idm.threshensemble > flavcham.idm.tstar] = 10
flavcham.idm.threshensemble[flavcham.idm.threshensemble <= flavcham.idm.tstar] = 0

flavcham.threshold <- flavcham.overlap.threshensemble + flavcham.idm.threshensemble
flavcham.thresh.spdf <- as(flavcham.threshold, "SpatialPixelsDataFrame")
flavcham.thresh.df <- as.data.frame(flavcham.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

flavcham.thresh.plot <- ggplot() +
  geom_tile(data = flavcham.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/flavcham-threshold.png", flavcham.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(flavcham.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(flavcham.overlapthresh[[i]], "SpatRaster")
...
flavcir.overlapnormlist <- vector(mode = "list", length = 100)
flavcir.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  flavcir.idmnormlist[[i]] =flavcir.idmnorm
  flavcir.overlapnormlist[[i]] =flavcir.overlapnorm
...
# Normalized
flavcir.overlapnorm.ensemble <- raster(mean(rast(flavcir.overlapnormlist[c(1:100)])))
flavcir.overlapnorm.spdf <- as(flavcir.overlapnorm.ensemble, "SpatialPixelsDataFrame")
flavcir.overlapnorm.df <- as.data.frame(flavcir.overlapnorm.spdf)

flavcir.overlapnorm.plot <- ggplot() +
  geom_tile(data = flavcir.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavcir-overlapnorm.png", flavcir.overlapnorm.plot, width = 6, height = 4, units = "in")

flavcir.idmnorm.ensemble <- raster(mean(rast(flavcir.idmnormlist[c(1:100)])))
flavcir.idmnorm.spdf <- as(flavcir.idmnorm.ensemble, "SpatialPixelsDataFrame")
flavcir.idmnorm.df <- as.data.frame(flavcir.idmnorm.spdf)

flavcir.idmnorm.plot <- ggplot() +
  geom_tile(data = flavcir.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavcir-idmnorm.png", flavcir.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
flavcir.overlap.tstar <- mean((flavcir.evaldf %>% filter(model == "overlap"))$tstar)
flavcir.overlap.threshensemble <- clamp(flavcir.overlapnorm.ensemble, lower = flavcir.overlap.tstar, upper = 1, values = T)
flavcir.overlap.threshensemble[flavcir.overlap.threshensemble > flavcir.overlap.tstar] = 1
flavcir.overlap.threshensemble[flavcir.overlap.threshensemble <= flavcir.overlap.tstar] = 0

flavcir.idm.tstar <- mean((flavcir.evaldf %>% filter(model == "IDM"))$tstar)
flavcir.idm.threshensemble <- clamp(flavcir.idmnorm.ensemble, lower = flavcir.idm.tstar, upper = 1, values = T)
flavcir.idm.threshensemble[flavcir.idm.threshensemble > flavcir.idm.tstar] = 10
flavcir.idm.threshensemble[flavcir.idm.threshensemble <= flavcir.idm.tstar] = 0

flavcir.threshold <- flavcir.overlap.threshensemble + flavcir.idm.threshensemble
flavcir.thresh.spdf <- as(flavcir.threshold, "SpatialPixelsDataFrame")
flavcir.thresh.df <- as.data.frame(flavcir.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

flavcir.thresh.plot <- ggplot() +
  geom_tile(data = flavcir.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/flavcir-threshold.png", flavcir.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(flavcir.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(flavcir.overlapthresh[[i]], "SpatRaster")
...
flavlup.overlapnormlist <- vector(mode = "list", length = 100)
flavlup.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  flavlup.idmnormlist[[i]] =flavlup.idmnorm
  flavlup.overlapnormlist[[i]] =flavlup.overlapnorm
...
# Normalized
flavlup.overlapnorm.ensemble <- raster(mean(rast(flavlup.overlapnormlist[c(1:100)])))
flavlup.overlapnorm.spdf <- as(flavlup.overlapnorm.ensemble, "SpatialPixelsDataFrame")
flavlup.overlapnorm.df <- as.data.frame(flavlup.overlapnorm.spdf)

flavlup.overlapnorm.plot <- ggplot() +
  geom_tile(data = flavlup.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavlup-overlapnorm.png", flavlup.overlapnorm.plot, width = 6, height = 4, units = "in")

flavlup.idmnorm.ensemble <- raster(mean(rast(flavlup.idmnormlist[c(1:100)])))
flavlup.idmnorm.spdf <- as(flavlup.idmnorm.ensemble, "SpatialPixelsDataFrame")
flavlup.idmnorm.df <- as.data.frame(flavlup.idmnorm.spdf)

flavlup.idmnorm.plot <- ggplot() +
  geom_tile(data = flavlup.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavlup-idmnorm.png", flavlup.idmnorm.plot, width = 6, height = 4, units = "in")


# Threshold
flavlup.overlap.tstar <- mean((flavlup.evaldf %>% filter(model == "overlap"))$tstar)
flavlup.overlap.threshensemble <- clamp(flavlup.overlapnorm.ensemble, lower = flavlup.overlap.tstar, upper = 1, values = T)
flavlup.overlap.threshensemble[flavlup.overlap.threshensemble > flavlup.overlap.tstar] = 1
flavlup.overlap.threshensemble[flavlup.overlap.threshensemble <= flavlup.overlap.tstar] = 0

flavlup.idm.tstar <- mean((flavlup.evaldf %>% filter(model == "IDM"))$tstar)
flavlup.idm.threshensemble <- clamp(flavlup.idmnorm.ensemble, lower = flavlup.idm.tstar, upper = 1, values = T)
flavlup.idm.threshensemble[flavlup.idm.threshensemble > flavlup.idm.tstar] = 10
flavlup.idm.threshensemble[flavlup.idm.threshensemble <= flavlup.idm.tstar] = 0

flavlup.threshold <- flavlup.overlap.threshensemble + flavlup.idm.threshensemble
flavlup.thresh.spdf <- as(flavlup.threshold, "SpatialPixelsDataFrame")
flavlup.thresh.df <- as.data.frame(flavlup.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

flavlup.thresh.plot <- ggplot() +
  geom_tile(data = flavlup.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/flavlup-threshold.png", flavlup.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(flavlup.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(flavlup.overlapthresh[[i]], "SpatRaster")
...
flavpen.overlapnormlist <- vector(mode = "list", length = 100)
flavpen.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  flavpen.idmnormlist[[i]] =flavpen.idmnorm
  flavpen.overlapnormlist[[i]] =flavpen.overlapnorm
...
# Normalized
flavpen.overlapnorm.ensemble <- raster(mean(rast(flavpen.overlapnormlist[c(1:100)])))
flavpen.overlapnorm.spdf <- as(flavpen.overlapnorm.ensemble, "SpatialPixelsDataFrame")
flavpen.overlapnorm.df <- as.data.frame(flavpen.overlapnorm.spdf)

flavpen.overlapnorm.plot <- ggplot() +
  geom_tile(data = flavpen.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavpen-overlapnorm.png", flavpen.overlapnorm.plot, width = 6, height = 4, units = "in")

flavpen.idmnorm.ensemble <- raster(mean(rast(flavpen.idmnormlist[c(1:100)])))
flavpen.idmnorm.spdf <- as(flavpen.idmnorm.ensemble, "SpatialPixelsDataFrame")
flavpen.idmnorm.df <- as.data.frame(flavpen.idmnorm.spdf)

flavpen.idmnorm.plot <- ggplot() +
  geom_tile(data = flavpen.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavpen-idmnorm.png", flavpen.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
flavpen.overlap.tstar <- mean((flavpen.evaldf %>% filter(model == "overlap"))$tstar)
flavpen.overlap.threshensemble <- clamp(flavpen.overlapnorm.ensemble, lower = flavpen.overlap.tstar, upper = 1, values = T)
flavpen.overlap.threshensemble[flavpen.overlap.threshensemble > flavpen.overlap.tstar] = 1
flavpen.overlap.threshensemble[flavpen.overlap.threshensemble <= flavpen.overlap.tstar] = 0

flavpen.idm.tstar <- mean((flavpen.evaldf %>% filter(model == "IDM"))$tstar)
flavpen.idm.threshensemble <- clamp(flavpen.idmnorm.ensemble, lower = flavpen.idm.tstar, upper = 1, values = T)
flavpen.idm.threshensemble[flavpen.idm.threshensemble > flavpen.idm.tstar] = 10
flavpen.idm.threshensemble[flavpen.idm.threshensemble <= flavpen.idm.tstar] = 0

flavpen.threshold <- flavpen.overlap.threshensemble + flavpen.idm.threshensemble
flavpen.thresh.spdf <- as(flavpen.threshold, "SpatialPixelsDataFrame")
flavpen.thresh.df <- as.data.frame(flavpen.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

flavpen.thresh.plot <- ggplot() +
  geom_tile(data = flavpen.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/flavpen-threshold.png", flavpen.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(flavpen.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(flavpen.overlapthresh[[i]], "SpatRaster")
...
flavrub.overlapnormlist <- vector(mode = "list", length = 100)
flavrub.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  flavrub.idmnormlist[[i]] =flavrub.idmnorm
  flavrub.overlapnormlist[[i]] =flavrub.overlapnorm
...
# Normalized
flavrub.overlapnorm.ensemble <- raster(mean(rast(flavrub.overlapnormlist[c(1:100)])))
flavrub.overlapnorm.spdf <- as(flavrub.overlapnorm.ensemble, "SpatialPixelsDataFrame")
flavrub.overlapnorm.df <- as.data.frame(flavrub.overlapnorm.spdf)

flavrub.overlapnorm.plot <- ggplot() +
  geom_tile(data = flavrub.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavrub-overlapnorm.png", flavrub.overlapnorm.plot, width = 6, height = 4, units = "in")

flavrub.idmnorm.ensemble <- raster(mean(rast(flavrub.idmnormlist[c(1:100)])))
flavrub.idmnorm.spdf <- as(flavrub.idmnorm.ensemble, "SpatialPixelsDataFrame")
flavrub.idmnorm.df <- as.data.frame(flavrub.idmnorm.spdf)

flavrub.idmnorm.plot <- ggplot() +
  geom_tile(data = flavrub.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/flavrub-idmnorm.png", flavrub.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
flavrub.overlap.tstar <- mean((flavrub.evaldf %>% filter(model == "overlap"))$tstar)
flavrub.overlap.threshensemble <- clamp(flavrub.overlapnorm.ensemble, lower = flavrub.overlap.tstar, upper = 1, values = T)
flavrub.overlap.threshensemble[flavrub.overlap.threshensemble > flavrub.overlap.tstar] = 1
flavrub.overlap.threshensemble[flavrub.overlap.threshensemble <= flavrub.overlap.tstar] = 0

flavrub.idm.tstar <- mean((flavrub.evaldf %>% filter(model == "IDM"))$tstar)
flavrub.idm.threshensemble <- clamp(flavrub.idmnorm.ensemble, lower = flavrub.idm.tstar, upper = 1, values = T)
flavrub.idm.threshensemble[flavrub.idm.threshensemble > flavrub.idm.tstar] = 10
flavrub.idm.threshensemble[flavrub.idm.threshensemble <= flavrub.idm.tstar] = 0

flavrub.threshold <- flavrub.overlap.threshensemble + flavrub.idm.threshensemble
flavrub.thresh.spdf <- as(flavrub.threshold, "SpatialPixelsDataFrame")
flavrub.thresh.df <- as.data.frame(flavrub.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

flavrub.thresh.plot <- ggplot() +
  geom_tile(data = flavrub.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/flavrub-threshold.png", flavrub.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(flavrub.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(flavrub.overlapthresh[[i]], "SpatRaster")
...
mixcham.overlapnormlist <- vector(mode = "list", length = 100)
mixcham.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  mixcham.idmnormlist[[i]] = mixcham.idmnorm
  mixcham.overlapnormlist[[i]] = mixcham.overlapnorm
...
# Normalized
mixcham.overlapnorm.ensemble <- raster(mean(rast(mixcham.overlapnormlist[c(1:100)])))
mixcham.overlapnorm.spdf <- as(mixcham.overlapnorm.ensemble, "SpatialPixelsDataFrame")
mixcham.overlapnorm.df <- as.data.frame(mixcham.overlapnorm.spdf)

mixcham.overlapnorm.plot <- ggplot() +
  geom_tile(data = mixcham.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixcham-overlapnorm.png", mixcham.overlapnorm.plot, width = 6, height = 4, units = "in")

mixcham.idmnorm.ensemble <- raster(mean(rast(mixcham.idmnormlist[c(1:100)])))
mixcham.idmnorm.spdf <- as(mixcham.idmnorm.ensemble, "SpatialPixelsDataFrame")
mixcham.idmnorm.df <- as.data.frame(mixcham.idmnorm.spdf)

mixcham.idmnorm.plot <- ggplot() +
  geom_tile(data = mixcham.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixcham-idmnorm.png", mixcham.idmnorm.plot, width = 6, height = 4, units = "in")


# Threshold
mixcham.overlap.tstar <- mean((mixcham.evaldf %>% filter(model == "overlap"))$tstar)
mixcham.overlap.threshensemble <- clamp(mixcham.overlapnorm.ensemble, lower = mixcham.overlap.tstar, upper = 1, values = T)
mixcham.overlap.threshensemble[mixcham.overlap.threshensemble > mixcham.overlap.tstar] = 1
mixcham.overlap.threshensemble[mixcham.overlap.threshensemble <= mixcham.overlap.tstar] = 0

mixcham.idm.tstar <- mean((mixcham.evaldf %>% filter(model == "IDM"))$tstar)
mixcham.idm.threshensemble <- clamp(mixcham.idmnorm.ensemble, lower = mixcham.idm.tstar, upper = 1, values = T)
mixcham.idm.threshensemble[mixcham.idm.threshensemble > mixcham.idm.tstar] = 10
mixcham.idm.threshensemble[mixcham.idm.threshensemble <= mixcham.idm.tstar] = 0

mixcham.threshold <- mixcham.overlap.threshensemble + mixcham.idm.threshensemble
mixcham.thresh.spdf <- as(mixcham.threshold, "SpatialPixelsDataFrame")
mixcham.thresh.df <- as.data.frame(mixcham.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

mixcham.thresh.plot <- ggplot() +
  geom_tile(data = mixcham.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/mixcham-threshold.png", mixcham.thresh.plot, width = 6, height = 4, units = "in")


## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(mixcham.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(mixcham.overlapthresh[[i]], "SpatRaster")
...
mixcir.overlapnormlist <- vector(mode = "list", length = 100)
mixcir.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  mixcir.idmnormlist[[i]] = mixcir.idmnorm
  mixcir.overlapnormlist[[i]] = mixcir.overlapnorm
...
# Normalized
mixcir.overlapnorm.ensemble <- raster(mean(rast(mixcir.overlapnormlist[c(1:100)])))
mixcir.overlapnorm.spdf <- as(mixcir.overlapnorm.ensemble, "SpatialPixelsDataFrame")
mixcir.overlapnorm.df <- as.data.frame(mixcir.overlapnorm.spdf)

mixcir.overlapnorm.plot <- ggplot() +
  geom_tile(data = mixcir.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixcir-overlapnorm.png", mixcir.overlapnorm.plot, width = 6, height = 4, units = "in")

mixcir.idmnorm.ensemble <- raster(mean(rast(mixcir.idmnormlist[c(1:100)])))
mixcir.idmnorm.spdf <- as(mixcir.idmnorm.ensemble, "SpatialPixelsDataFrame")
mixcir.idmnorm.df <- as.data.frame(mixcir.idmnorm.spdf)

mixcir.idmnorm.plot <- ggplot() +
  geom_tile(data = mixcir.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixcir-idmnorm.png", mixcir.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
mixcir.overlap.tstar <- mean((mixcir.evaldf %>% filter(model == "overlap"))$tstar)
mixcir.overlap.threshensemble <- clamp(mixcir.overlapnorm.ensemble, lower = mixcir.overlap.tstar, upper = 1, values = T)
mixcir.overlap.threshensemble[mixcir.overlap.threshensemble > mixcir.overlap.tstar] = 1
mixcir.overlap.threshensemble[mixcir.overlap.threshensemble <= mixcir.overlap.tstar] = 0

mixcir.idm.tstar <- mean((mixcir.evaldf %>% filter(model == "IDM"))$tstar)
mixcir.idm.threshensemble <- clamp(mixcir.idmnorm.ensemble, lower = mixcir.idm.tstar, upper = 1, values = T)
mixcir.idm.threshensemble[mixcir.idm.threshensemble > mixcir.idm.tstar] = 10
mixcir.idm.threshensemble[mixcir.idm.threshensemble <= mixcir.idm.tstar] = 0

mixcir.threshold <- mixcir.overlap.threshensemble + mixcir.idm.threshensemble
mixcir.thresh.spdf <- as(mixcir.threshold, "SpatialPixelsDataFrame")
mixcir.thresh.df <- as.data.frame(mixcir.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

mixcir.thresh.plot <- ggplot() +
  geom_tile(data = mixcir.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/mixcir-threshold.png", mixcir.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(mixcir.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(mixcir.overlapthresh[[i]], "SpatRaster")
...
mixlup.overlapnormlist <- vector(mode = "list", length = 100)
mixlup.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  mixlup.idmnormlist[[i]] = mixlup.idmnorm
  mixlup.overlapnormlist[[i]] = mixlup.overlapnorm
...
# Normalized
mixlup.overlapnorm.ensemble <- raster(mean(rast(mixlup.overlapnormlist[c(1:100)])))
mixlup.overlapnorm.spdf <- as(mixlup.overlapnorm.ensemble, "SpatialPixelsDataFrame")
mixlup.overlapnorm.df <- as.data.frame(mixlup.overlapnorm.spdf)

mixlup.overlapnorm.plot <- ggplot() +
  geom_tile(data = mixlup.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixlup-overlapnorm.png", mixlup.overlapnorm.plot, width = 6, height = 4, units = "in")

mixlup.idmnorm.ensemble <- raster(mean(rast(mixlup.idmnormlist[c(1:100)])))
mixlup.idmnorm.spdf <- as(mixlup.idmnorm.ensemble, "SpatialPixelsDataFrame")
mixlup.idmnorm.df <- as.data.frame(mixlup.idmnorm.spdf)

mixlup.idmnorm.plot <- ggplot() +
  geom_tile(data = mixlup.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixlup-idmnorm.png", mixlup.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
mixlup.overlap.tstar <- mean((mixlup.evaldf %>% filter(model == "overlap"))$tstar)
mixlup.overlap.threshensemble <- clamp(mixlup.overlapnorm.ensemble, lower = mixlup.overlap.tstar, upper = 1, values = T)
mixlup.overlap.threshensemble[mixlup.overlap.threshensemble > mixlup.overlap.tstar] = 1
mixlup.overlap.threshensemble[mixlup.overlap.threshensemble <= mixlup.overlap.tstar] = 0

mixlup.idm.tstar <- mean((mixlup.evaldf %>% filter(model == "IDM"))$tstar)
mixlup.idm.threshensemble <- clamp(mixlup.idmnorm.ensemble, lower = mixlup.idm.tstar, upper = 1, values = T)
mixlup.idm.threshensemble[mixlup.idm.threshensemble > mixlup.idm.tstar] = 10
mixlup.idm.threshensemble[mixlup.idm.threshensemble <= mixlup.idm.tstar] = 0

mixlup.threshold <- mixlup.overlap.threshensemble + mixlup.idm.threshensemble
mixlup.thresh.spdf <- as(mixlup.threshold, "SpatialPixelsDataFrame")
mixlup.thresh.df <- as.data.frame(mixlup.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

mixlup.thresh.plot <- ggplot() +
  geom_tile(data = mixlup.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/mixlup-threshold.png", mixlup.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(mixlup.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(mixlup.overlapthresh[[i]], "SpatRaster")
...
mixpen.overlapnormlist <- vector(mode = "list", length = 100)
mixpen.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  mixpen.idmnormlist[[i]] = mixpen.idmnorm
  mixpen.overlapnormlist[[i]] = mixpen.overlapnorm
...
# Normalized
mixpen.overlapnorm.ensemble <- raster(mean(rast(mixpen.overlapnormlist[c(1:100)])))
mixpen.overlapnorm.spdf <- as(mixpen.overlapnorm.ensemble, "SpatialPixelsDataFrame")
mixpen.overlapnorm.df <- as.data.frame(mixpen.overlapnorm.spdf)

mixpen.overlapnorm.plot <- ggplot() +
  geom_tile(data = mixpen.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixpen-overlapnorm.png", mixpen.overlapnorm.plot, width = 6, height = 4, units = "in")

mixpen.idmnorm.ensemble <- raster(mean(rast(mixpen.idmnormlist[c(1:100)])))
mixpen.idmnorm.spdf <- as(mixpen.idmnorm.ensemble, "SpatialPixelsDataFrame")
mixpen.idmnorm.df <- as.data.frame(mixpen.idmnorm.spdf)

mixpen.idmnorm.plot <- ggplot() +
  geom_tile(data = mixpen.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixpen-idmnorm.png", mixpen.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
mixpen.overlap.tstar <- mean((mixpen.evaldf %>% filter(model == "overlap"))$tstar)
mixpen.overlap.threshensemble <- clamp(mixpen.overlapnorm.ensemble, lower = mixpen.overlap.tstar, upper = 1, values = T)
mixpen.overlap.threshensemble[mixpen.overlap.threshensemble > mixpen.overlap.tstar] = 1
mixpen.overlap.threshensemble[mixpen.overlap.threshensemble <= mixpen.overlap.tstar] = 0

mixpen.idm.tstar <- mean((mixpen.evaldf %>% filter(model == "IDM"))$tstar)
mixpen.idm.threshensemble <- clamp(mixpen.idmnorm.ensemble, lower = mixpen.idm.tstar, upper = 1, values = T)
mixpen.idm.threshensemble[mixpen.idm.threshensemble > mixpen.idm.tstar] = 10
mixpen.idm.threshensemble[mixpen.idm.threshensemble <= mixpen.idm.tstar] = 0

mixpen.threshold <- mixpen.overlap.threshensemble + mixpen.idm.threshensemble
mixpen.thresh.spdf <- as(mixpen.threshold, "SpatialPixelsDataFrame")
mixpen.thresh.df <- as.data.frame(mixpen.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

mixpen.thresh.plot <- ggplot() +
  geom_tile(data = mixpen.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/mixpen-threshold.png", mixpen.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(mixpen.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(mixpen.overlapthresh[[i]], "SpatRaster")
...
mixrub.overlapnormlist <- vector(mode = "list", length = 100)
mixrub.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  mixrub.idmnormlist[[i]] = mixrub.idmnorm
  mixrub.overlapnormlist[[i]] = mixrub.overlapnorm
...
# Normalized
mixrub.overlapnorm.ensemble <- raster(mean(rast(mixrub.overlapnormlist[c(1:100)])))
mixrub.overlapnorm.spdf <- as(mixrub.overlapnorm.ensemble, "SpatialPixelsDataFrame")
mixrub.overlapnorm.df <- as.data.frame(mixrub.overlapnorm.spdf)

mixrub.overlapnorm.plot <- ggplot() +
  geom_tile(data = mixrub.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixrub-overlapnorm.png", mixrub.overlapnorm.plot, width = 6, height = 4, units = "in")

mixrub.idmnorm.ensemble <- raster(mean(rast(mixrub.idmnormlist[c(1:100)])))
mixrub.idmnorm.spdf <- as(mixrub.idmnorm.ensemble, "SpatialPixelsDataFrame")
mixrub.idmnorm.df <- as.data.frame(mixrub.idmnorm.spdf)

mixrub.idmnorm.plot <- ggplot() +
  geom_tile(data = mixrub.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/mixrub-idmnorm.png", mixrub.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
mixrub.overlap.tstar <- mean((mixrub.evaldf %>% filter(model == "overlap"))$tstar)
mixrub.overlap.threshensemble <- clamp(mixrub.overlapnorm.ensemble, lower = mixrub.overlap.tstar, upper = 1, values = T)
mixrub.overlap.threshensemble[mixrub.overlap.threshensemble > mixrub.overlap.tstar] = 1
mixrub.overlap.threshensemble[mixrub.overlap.threshensemble <= mixrub.overlap.tstar] = 0

mixrub.idm.tstar <- mean((mixrub.evaldf %>% filter(model == "IDM"))$tstar)
mixrub.idm.threshensemble <- clamp(mixrub.idmnorm.ensemble, lower = mixrub.idm.tstar, upper = 1, values = T)
mixrub.idm.threshensemble[mixrub.idm.threshensemble > mixrub.idm.tstar] = 10
mixrub.idm.threshensemble[mixrub.idm.threshensemble <= mixrub.idm.tstar] = 0

mixrub.threshold <- mixrub.overlap.threshensemble + mixrub.idm.threshensemble
mixrub.thresh.spdf <- as(mixrub.threshold, "SpatialPixelsDataFrame")
mixrub.thresh.df <- as.data.frame(mixrub.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

mixrub.thresh.plot <- ggplot() +
  geom_tile(data = mixrub.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/mixrub-threshold.png", mixrub.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(mixrub.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(mixrub.overlapthresh[[i]], "SpatRaster")
...
voscham.overlapnormlist <- vector(mode = "list", length = 100)
voscham.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  voscham.idmnormlist[[i]] = voscham.idmnorm
  voscham.overlapnormlist[[i]] = voscham.overlapnorm
...
# Normalized
voscham.overlapnorm.ensemble <- raster(mean(rast(voscham.overlapnormlist[c(1:100)])))
voscham.overlapnorm.spdf <- as(voscham.overlapnorm.ensemble, "SpatialPixelsDataFrame")
voscham.overlapnorm.df <- as.data.frame(voscham.overlapnorm.spdf)

voscham.overlapnorm.plot <- ggplot() +
  geom_tile(data = voscham.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/voscham-overlapnorm.png", voscham.overlapnorm.plot, width = 6, height = 4, units = "in")

voscham.idmnorm.ensemble <- raster(mean(rast(voscham.idmnormlist[c(1:100)])))
voscham.idmnorm.spdf <- as(voscham.idmnorm.ensemble, "SpatialPixelsDataFrame")
voscham.idmnorm.df <- as.data.frame(voscham.idmnorm.spdf)

voscham.idmnorm.plot <- ggplot() +
  geom_tile(data = voscham.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/voscham-idmnorm.png", voscham.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
voscham.overlap.tstar <- mean((voscham.evaldf %>% filter(model == "overlap"))$tstar)
voscham.overlap.threshensemble <- clamp(voscham.overlapnorm.ensemble, lower = voscham.overlap.tstar, upper = 1, values = T)
voscham.overlap.threshensemble[voscham.overlap.threshensemble > voscham.overlap.tstar] = 1
voscham.overlap.threshensemble[voscham.overlap.threshensemble <= voscham.overlap.tstar] = 0

voscham.idm.tstar <- mean((voscham.evaldf %>% filter(model == "IDM"))$tstar)
voscham.idm.threshensemble <- clamp(voscham.idmnorm.ensemble, lower = voscham.idm.tstar, upper = 1, values = T)
voscham.idm.threshensemble[voscham.idm.threshensemble > voscham.idm.tstar] = 10
voscham.idm.threshensemble[voscham.idm.threshensemble <= voscham.idm.tstar] = 0

voscham.threshold <- voscham.overlap.threshensemble + voscham.idm.threshensemble
voscham.thresh.spdf <- as(voscham.threshold, "SpatialPixelsDataFrame")
voscham.thresh.df <- as.data.frame(voscham.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

voscham.thresh.plot <- ggplot() +
  geom_tile(data = voscham.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/voscham-threshold.png", voscham.thresh.plot, width = 6, height = 4, units = "in")


## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(voscham.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(voscham.overlapthresh[[i]], "SpatRaster")
...
voscir.overlapnormlist <- vector(mode = "list", length = 100)
voscir.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  voscir.idmnormlist[[i]] = voscir.idmnorm
  voscir.overlapnormlist[[i]] = voscir.overlapnorm
...
# Normalized
voscir.overlapnorm.ensemble <- raster(mean(rast(voscir.overlapnormlist[c(1:100)])))
voscir.overlapnorm.spdf <- as(voscir.overlapnorm.ensemble, "SpatialPixelsDataFrame")
voscir.overlapnorm.df <- as.data.frame(voscir.overlapnorm.spdf)

voscir.overlapnorm.plot <- ggplot() +
  geom_tile(data = voscir.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/voscir-overlapnorm.png", voscir.overlapnorm.plot, width = 6, height = 4, units = "in")

voscir.idmnorm.ensemble <- raster(mean(rast(voscir.idmnormlist[c(1:100)])))
voscir.idmnorm.spdf <- as(voscir.idmnorm.ensemble, "SpatialPixelsDataFrame")
voscir.idmnorm.df <- as.data.frame(voscir.idmnorm.spdf)

voscir.idmnorm.plot <- ggplot() +
  geom_tile(data = voscir.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/voscir-idmnorm.png", voscir.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
voscir.overlap.tstar <- mean((voscir.evaldf %>% filter(model == "overlap"))$tstar)
voscir.overlap.threshensemble <- clamp(voscir.overlapnorm.ensemble, lower = voscir.overlap.tstar, upper = 1, values = T)
voscir.overlap.threshensemble[voscir.overlap.threshensemble > voscir.overlap.tstar] = 1
voscir.overlap.threshensemble[voscir.overlap.threshensemble <= voscir.overlap.tstar] = 0

voscir.idm.tstar <- mean((voscir.evaldf %>% filter(model == "IDM"))$tstar)
voscir.idm.threshensemble <- clamp(voscir.idmnorm.ensemble, lower = voscir.idm.tstar, upper = 1, values = T)
voscir.idm.threshensemble[voscir.idm.threshensemble > voscir.idm.tstar] = 10
voscir.idm.threshensemble[voscir.idm.threshensemble <= voscir.idm.tstar] = 0

voscir.threshold <- voscir.overlap.threshensemble + voscir.idm.threshensemble
voscir.thresh.spdf <- as(voscir.threshold, "SpatialPixelsDataFrame")
voscir.thresh.df <- as.data.frame(voscir.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

voscir.thresh.plot <- ggplot() +
  geom_tile(data = voscir.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/voscir-threshold.png", voscir.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(voscir.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(voscir.overlapthresh[[i]], "SpatRaster")
...
voslup.overlapnormlist <- vector(mode = "list", length = 100)
voslup.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  voslup.idmnormlist[[i]] = voslup.idmnorm
  voslup.overlapnormlist[[i]] = voslup.overlapnorm
...
# Normalized
voslup.overlapnorm.ensemble <- raster(mean(rast(voslup.overlapnormlist[c(1:100)])))
voslup.overlapnorm.spdf <- as(voslup.overlapnorm.ensemble, "SpatialPixelsDataFrame")
voslup.overlapnorm.df <- as.data.frame(voslup.overlapnorm.spdf)

voslup.overlapnorm.plot <- ggplot() +
  geom_tile(data = voslup.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/voslup-overlapnorm.png", voslup.overlapnorm.plot, width = 6, height = 4, units = "in")

voslup.idmnorm.ensemble <- raster(mean(rast(voslup.idmnormlist[c(1:100)])))
voslup.idmnorm.spdf <- as(voslup.idmnorm.ensemble, "SpatialPixelsDataFrame")
voslup.idmnorm.df <- as.data.frame(voslup.idmnorm.spdf)

voslup.idmnorm.plot <- ggplot() +
  geom_tile(data = voslup.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/voslup-idmnorm.png", voslup.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
voslup.overlap.tstar <- mean((voslup.evaldf %>% filter(model == "overlap"))$tstar)
voslup.overlap.threshensemble <- clamp(voslup.overlapnorm.ensemble, lower = voslup.overlap.tstar, upper = 1, values = T)
voslup.overlap.threshensemble[voslup.overlap.threshensemble > voslup.overlap.tstar] = 1
voslup.overlap.threshensemble[voslup.overlap.threshensemble <= voslup.overlap.tstar] = 0

voslup.idm.tstar <- mean((voslup.evaldf %>% filter(model == "IDM"))$tstar)
voslup.idm.threshensemble <- clamp(voslup.idmnorm.ensemble, lower = voslup.idm.tstar, upper = 1, values = T)
voslup.idm.threshensemble[voslup.idm.threshensemble > voslup.idm.tstar] = 10
voslup.idm.threshensemble[voslup.idm.threshensemble <= voslup.idm.tstar] = 0

voslup.threshold <- voslup.overlap.threshensemble + voslup.idm.threshensemble
voslup.thresh.spdf <- as(voslup.threshold, "SpatialPixelsDataFrame")
voslup.thresh.df <- as.data.frame(voslup.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

voslup.thresh.plot <- ggplot() +
  geom_tile(data = voslup.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/voslup-threshold.png", voslup.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(voslup.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(voslup.overlapthresh[[i]], "SpatRaster")
...
vospen.overlapnormlist <- vector(mode = "list", length = 100)
vospen.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  vospen.idmnormlist[[i]] = vospen.idmnorm
  vospen.overlapnormlist[[i]] = vospen.overlapnorm
...
# Normalized
vospen.overlapnorm.ensemble <- raster(mean(rast(vospen.overlapnormlist[c(1:100)])))
vospen.overlapnorm.spdf <- as(vospen.overlapnorm.ensemble, "SpatialPixelsDataFrame")
vospen.overlapnorm.df <- as.data.frame(vospen.overlapnorm.spdf)

vospen.overlapnorm.plot <- ggplot() +
  geom_tile(data = vospen.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/vospen-overlapnorm.png", vospen.overlapnorm.plot, width = 6, height = 4, units = "in")

vospen.idmnorm.ensemble <- raster(mean(rast(vospen.idmnormlist[c(1:100)])))
vospen.idmnorm.spdf <- as(vospen.idmnorm.ensemble, "SpatialPixelsDataFrame")
vospen.idmnorm.df <- as.data.frame(vospen.idmnorm.spdf)

vospen.idmnorm.plot <- ggplot() +
  geom_tile(data = vospen.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/vospen-idmnorm.png", vospen.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
vospen.overlap.tstar <- mean((vospen.evaldf %>% filter(model == "overlap"))$tstar)
vospen.overlap.threshensemble <- clamp(vospen.overlapnorm.ensemble, lower = vospen.overlap.tstar, upper = 1, values = T)
vospen.overlap.threshensemble[vospen.overlap.threshensemble > vospen.overlap.tstar] = 1
vospen.overlap.threshensemble[vospen.overlap.threshensemble <= vospen.overlap.tstar] = 0

vospen.idm.tstar <- mean((vospen.evaldf %>% filter(model == "IDM"))$tstar)
vospen.idm.threshensemble <- clamp(vospen.idmnorm.ensemble, lower = vospen.idm.tstar, upper = 1, values = T)
vospen.idm.threshensemble[vospen.idm.threshensemble > vospen.idm.tstar] = 10
vospen.idm.threshensemble[vospen.idm.threshensemble <= vospen.idm.tstar] = 0

vospen.threshold <- vospen.overlap.threshensemble + vospen.idm.threshensemble
vospen.thresh.spdf <- as(vospen.threshold, "SpatialPixelsDataFrame")
vospen.thresh.df <- as.data.frame(vospen.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

vospen.thresh.plot <- ggplot() +
  geom_tile(data = vospen.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/vospen-threshold.png", vospen.thresh.plot, width = 6, height = 4, units = "in")

## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(vospen.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(vospen.overlapthresh[[i]], "SpatRaster")
...
vosrub.overlapnormlist <- vector(mode = "list", length = 100)
vosrub.idmnormlist <- vector(mode = "list", length = 100)
...
for(i in 1:100){
  ...
  vosrub.idmnormlist[[i]] = vosrub.idmnorm
  vosrub.overlapnormlist[[i]] = vosrub.overlapnorm
...
# Normalized
vosrub.overlapnorm.ensemble <- raster(mean(rast(vosrub.overlapnormlist[c(1:100)])))
vosrub.overlapnorm.spdf <- as(vosrub.overlapnorm.ensemble, "SpatialPixelsDataFrame")
vosrub.overlapnorm.df <- as.data.frame(vosrub.overlapnorm.spdf)

vosrub.overlapnorm.plot <- ggplot() +
  geom_tile(data = vosrub.overlapnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/vosrub-overlapnorm.png", vosrub.overlapnorm.plot, width = 6, height = 4, units = "in")

vosrub.idmnorm.ensemble <- raster(mean(rast(vosrub.idmnormlist[c(1:100)])))
vosrub.idmnorm.spdf <- as(vosrub.idmnorm.ensemble, "SpatialPixelsDataFrame")
vosrub.idmnorm.df <- as.data.frame(vosrub.idmnorm.spdf)

vosrub.idmnorm.plot <- ggplot() +
  geom_tile(data = vosrub.idmnorm.df, aes(x = x, y = y, fill = mean)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_viridis(option = "magma", 
                     limits = c(0, 1))
ggsave("figures/normalized/vosrub-idmnorm.png", vosrub.idmnorm.plot, width = 6, height = 4, units = "in")

# Threshold
vosrub.overlap.tstar <- mean((vosrub.evaldf %>% filter(model == "overlap"))$tstar)
vosrub.overlap.threshensemble <- clamp(vosrub.overlapnorm.ensemble, lower = vosrub.overlap.tstar, upper = 1, values = T)
vosrub.overlap.threshensemble[vosrub.overlap.threshensemble > vosrub.overlap.tstar] = 1
vosrub.overlap.threshensemble[vosrub.overlap.threshensemble <= vosrub.overlap.tstar] = 0

vosrub.idm.tstar <- mean((vosrub.evaldf %>% filter(model == "IDM"))$tstar)
vosrub.idm.threshensemble <- clamp(vosrub.idmnorm.ensemble, lower = vosrub.idm.tstar, upper = 1, values = T)
vosrub.idm.threshensemble[vosrub.idm.threshensemble > vosrub.idm.tstar] = 10
vosrub.idm.threshensemble[vosrub.idm.threshensemble <= vosrub.idm.tstar] = 0

vosrub.threshold <- vosrub.overlap.threshensemble + vosrub.idm.threshensemble
vosrub.thresh.spdf <- as(vosrub.threshold, "SpatialPixelsDataFrame")
vosrub.thresh.df <- as.data.frame(vosrub.thresh.spdf) %>%
  mutate(layer = as.factor(layer))

vosrub.thresh.plot <- ggplot() +
  geom_tile(data = vosrub.thresh.df, aes(x = x, y = y, fill = layer)) +
  coord_cartesian(xlim = c(-130, -110), ylim = c(40, 50)) +
  theme_map() +
  scale_fill_manual(values = c("#000004",
                                  "#721f81",
                    ...
                    labels = c("N/A",
                                  ...
                                  "Overlap & IDM")) +
  theme(legend.title = element_blank())
ggsave("figures/normalized/vosrub-threshold.png", vosrub.thresh.plot, width = 6, height = 4, units = "in")


## Calculate Threshold Areas
for(i in 1:100){
idm.thresh <- as(vosrub.idmthresh[[i]], "SpatRaster")
idm.thresh[idm.thresh == 1] = 10
overlap.thresh <- as(vosrub.overlapthresh[[i]], "SpatRaster")
...
```{r final save}
write.csv(area.allruns, file = "thresh-areas-all.csv")
```
